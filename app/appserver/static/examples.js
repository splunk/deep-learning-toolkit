...
require([
    ...
    $(".dashboard-dashboardpage").css("background-image","linear-gradient(#bababa, #eeeeee, #bababa)");
    $(".dashboard-body").css("background", "none");  
    $(".dashboard-header-title").css("display","block");
    ...
    DashboardController.onReady(function() {
        ...
        DashboardController.onViewModelLoad(function() {
            ...
            var exampleInfoLoaded = exampleInfoCollection.fetch({
                url: SplunkUtil.make_url('/static/app/' + app +'/examples.json'),
                cache: true
            });
