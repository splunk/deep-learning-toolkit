...
class SpecParserTestCase(unittest.TestCase):
    ...
    def runTest(self):
        ...
        * Optional.
        ...
        self.assertIsNotNone(test_stanza)
        self.assertEqual(len(test_stanza.attributes), 2)
        ...
        param_f = test_stanza.get_attribute("param_f")
        self.assertIsNotNone(param_f)
        self.assertEqual(param_f.name, "param_f")
        self.assertEqual(param_f.value_spec, "")
        self.assertEqual(param_f.is_required, False)
        self.assertEqual(len(param_f.docs), 0)
