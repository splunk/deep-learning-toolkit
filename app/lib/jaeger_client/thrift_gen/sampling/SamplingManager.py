...
class Client(Iface):
  ...
  def getSamplingStrategy(self, serviceName):
    ...
    return self.recv_getSamplingStrategy()

  def send_getSamplingStrategy(self, serviceName):
    self._oprot.writeMessageBegin('getSamplingStrategy', TMessageType.CALL, self._seqid)
  ...
  def recv_getSamplingStrategy(self):
    iprot = self._iprot
...
class Processor(Iface, TProcessor):
  ...
  def process_getSamplingStrategy(self, seqid, iprot, oprot):
    ...
    result = getSamplingStrategy_result()
    try:
      result.success = self._handler.getSamplingStrategy(args.serviceName)
    ...
    oprot.writeMessageBegin("getSamplingStrategy", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
